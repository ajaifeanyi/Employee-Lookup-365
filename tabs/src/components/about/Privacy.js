        ...
        <section class="privacy-text">
          <div class="container">
            ...
            <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
              information when You use the Employee Lookup Application and tells You about Your privacy rights and
              how the law protects You.</p>
            <p>We use Your Personal data to provide and improve the Employee Lookup Application. By using the Employee
              Contacts Application, You agree to the collection and use of information in accordance with this Privacy
              Policy.</p>
            ...
            <ul>
              <li>
                <p><strong>Account</strong> means a unique account created for You to access the Employee Lookup
                  Application or parts of the Employee Lookup Application.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You
                  on any electronic device, named Employee Lookup</p>
              </li>
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Reliance Infosystems Limited.</p>
              </li>
              <li>
                <p><strong>Country</strong> refers to: Nigeria</p>
              </li>
              <li>
                <p><strong>Device</strong> means any device that can access the Employee Lookup Application such
              ...
              <li>
                <p><strong>Service Provider</strong> means any natural or legal person who processes the data on
                  ...
                  to facilitate the Employee Lookup Application, to provide the Employee Lookup Application on
                  behalf of the Company, to perform services related to the Employee Lookup Application or to
                  assist the Company in analyzing how the Employee Lookup Application is used.</p>
              </li>
              <li>
                <p><strong>Usage Data</strong> refers to data collected automatically, either generated by the use
                  of the Employee Lookup Application or from the Employee Lookup Application infrastructure
                  itself (for example, the duration of a page visit).</p>
              </li>
              <li>
                <p><strong>You</strong> means the individual accessing or using the Employee Lookup Application,
                  or the company, or other legal entity on behalf of which such individual is accessing or using
                  the Employee Lookup Application, as applicable.</p>
              </li>
            </ul>
            <h2>Collecting and Using Your Personal Data</h2>
            <h3>Types of Data Collected</h3>
            <h4>Personal Data</h4>
            <p>While using the Employee Lookup Application, we would have access to certain personally identifiable
            ...
            <h4>Usage Data</h4>
            <p>Usage Data is collected automatically when using the Employee Lookup Application.</p>
            <p>Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address),
              browser type, browser version, the pages of the Employee Lookup Application that You visit, the time
              and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic
              data.</p>
            <p>When You access the Employee Lookup Application by or through a mobile device, We may collect certain
            ...
            <p>We may also collect information that Your browser sends whenever You visit the Employee Lookup
              Application or when You access the Employee Lookup Application by or through a mobile device.</p>
            <h3>Use of Your Personal Data</h3>
            <p>The Company may use Personal Data for the following purposes:</p>
            <ul>
              <li>
                <p><strong>To provide and maintain the Employee Lookup Application</strong>, including to monitor
                  the usage of the Employee Lookup Application.</p>
              </li>
              <li>
                <p><strong>To manage Your Account:</strong> the Personal Data we have can give You access to
                  different functionalities of the Employee Lookup Application that are available to You as a
                  registered user.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a
                  ...
                  similar proceeding, in which Personal Data held by Us about the Employee Lookup Application
              ...
              <li>
                <p><strong>For other purposes</strong>: We may use Your information for other purposes, such as data
                  analysis, identifying usage trends and to evaluate and improve the Employee Lookup
                  Application, products, services, marketing and your experience.</p>
              </li>
            </ul>
            <p>We may share Your personal information in the following situations:</p>
            <ul>
              <li><strong>With Service Providers:</strong> We may share Your personal information with Service
                Providers to monitor and analyze the use of the Employee Lookup Application, to contact You.</li>
            ...
            <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
              ...
              functionality of the Employee Lookup Application, or We are legally obligated to retain this data for
            ...
            <ul>
              ...
              <li>Prevent or investigate possible wrongdoing in connection with the Employee Lookup Application</li>
              <li>Protect the personal safety of Users of the Employee Lookup Application or the public</li>
            ...
            <p>The Employee Lookup Application may contain links to other websites that are not operated by Us. If You
            ...
            <p>We may update Our Privacy Policy from time to time. We may not notify You of any changes but this page
              would be updated to reflect the new Privacy Policy.</p>
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact support at <span>support@relianceinfosystems.com</span></p>
          </div>
        </section>
