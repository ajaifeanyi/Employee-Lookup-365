...
var storageName = contains(provisionParameters, 'frontendHostingStorageName') ? provisionParameters['frontendHostingStorageName'] : '${resourceBaseName}01tab' // Try to read name for frontend hosting Storage Account from parameters
